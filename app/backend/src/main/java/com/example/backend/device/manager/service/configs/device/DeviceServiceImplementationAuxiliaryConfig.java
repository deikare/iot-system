...
public class DeviceServiceImplementationAuxiliaryConfig {
    ...
    public DeviceServiceImplementationAuxiliaryConfig(DeviceRepository deviceRepository, DeviceNotFoundExceptionBuilder builder, MasterServiceImplementation<Hub, Device, HubRepository, HubNotFoundException> hubServiceImplementation) {
    ...
    @Bean
    MasterServiceImplementation<Device, ControlSignal, DeviceRepository, DeviceNotFoundException> deviceMasterServiceImplementation() {
        return new MasterServiceImplementation<>(deviceRepository, builder);
    }

    @Bean
    DependentServiceImplementation<Device, Hub, DeviceRepository, HubRepository, DeviceNotFoundException, HubNotFoundException> deviceDependentServiceImplementation() {
