...
public class Device implements MasterAndDependentTypeInterface<Device, ControlSignal, Hub>, KafkaRecordInterface<Long> {
    ...
    private com.example.backend.device.manager.model.DeviceType deviceType;

    public Device(String name, Hub hub, com.example.backend.device.manager.model.DeviceType deviceType) {
        this.name = name;
        this.hub = hub;
    ...
    public com.example.backend.device.manager.model.DeviceType getDeviceType() {
        return deviceType;
    }

    public void setDeviceType(com.example.backend.device.manager.model.DeviceType deviceType) {
        this.deviceType = deviceType;
    }
    ...
    private void updateDeviceType(Device patch) {
        com.example.backend.device.manager.model.DeviceType newDeviceType = patch.getDeviceType();
